...
I am making my first open-source contribution in this course, and I have about one unit of time for it. I can take a single bounded bug with a stated current and expected behavior, a small UI fix, or a documentation change that names the pages to edit. I want to avoid umbrella or tracking issues, work in core internals such as a parser, and anything that still needs a product decision before code can start.
